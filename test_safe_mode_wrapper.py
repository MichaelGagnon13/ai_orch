...
sys.modules['agentscope'] = type('MockModule', (), {
...
sys.modules['agentscope.model'] = type('ModelModule', (), {'OpenAIChatModel': type, 'AnthropicChatModel': type})()
sys.modules['agentscope.formatter'] = type('FormatterModule', (), {'OpenAIChatFormatter': type, 'AnthropicChatFormatter': type})()

# Maintenant on peut importer
from src.orchestrate import sanitize_for_studio, SAFE_MODE, Msg
...
print(f'  Input content: [1,2,3,4,5]')
print(f'  Sanitized content: {msg.content}')
assert _payload(msg.content) == {'_array_length': 5}, f'Expected {{"_array_length": 5}}, got {msg.content}'
...
print(f'  Input: complex nested structure')
